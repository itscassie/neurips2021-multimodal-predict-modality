...
if input_train_mod2.var['feature_types'][0] == 'ATAC':
    ...
    if LOAD_MODEL:
        ...
        # model (4b) ga
        model_pth = meta['resources_dir'] + '/model/weights_v10/atac2gex/model_best_AtoB_cycle_atac2gex_v2_Nov17-16-48.pt'
        ...
        # ensemble
        y_pred = (
            np.array(y5b_pred_ga) + np.array(y6b_pred_ga) + np.array(y8b_pred_tfidf) + np.array(y4b_pred_ga)
            ) / 4
