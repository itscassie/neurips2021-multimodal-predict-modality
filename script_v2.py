...
if input_train_mod2.var["feature_types"][0] == "ATAC":
    ...
    HIDDEN_DIM = 1000
    MODEL_PTH = (
        meta["resources_dir"] + "/model/weights/gex2adt/model_nn_gex2adt_l1reg_e100.pt"
    )
    ...
    MODEL_PTH = (
        meta["resources_dir"]
        + "/model/weights/adt2gex/model_cycle_AtoB_adt2gex_e250.pt"
    )
    ...
    MODEL_PTH = (
        meta["resources_dir"]
        + "/model/weights/atac2gex/model_cycle_AtoB_atac2gex_e250.pt"
    )
