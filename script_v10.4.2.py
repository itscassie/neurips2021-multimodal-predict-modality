...
if input_train_mod2.var['feature_types'][0] == 'ATAC':
    ...
    if LOAD_MODEL:
        ...
        # model (22) pca
        y22_pred_pca = pca(input_train_mod1, input_test_mod1, n=50, iter=10)

        # model (27) pca
        y27_pred_pca = pca(input_train_mod1, input_test_mod1, n=100)
        ...
        y_pred = (
            ...
            np.array(y22_pred_pca) + np.array(y27_pred_pca)
        ) / 10
    ...
    if LOAD_MODEL:
        ...
        # model (5) concat
        model_pth = meta['resources_dir'] + '/model/weights_v10/adt2gex/model_best_AtoB_cycle_adt2gex_v2_tfidfconcat_Nov17-21-42.pt'
        ...
        # model (6) nn
        model_pth = meta['resources_dir'] + '/model/weights_v10/adt2gex/model_best_AtoB_cycle_adt2gex_v2_Nov17-18-23.pt'
        ...
        y_pred = (
            ...
            np.array(y5_pred_concat) + np.array(y6_pred_nn)
            ) / 5
