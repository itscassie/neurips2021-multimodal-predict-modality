...
if input_train_mod2.var["feature_types"][0] == "ATAC":
    ...
    if LOAD_MODEL:
        ...
        model_pth = (
            meta["resources_dir"]
            + "/model/weights_v5/gex2atac/model_AtoB_cycle_gex2atac_v2_Nov17-23-18.pt"
        )
    ...
    if LOAD_MODEL:
        ...
        model_pth = (
            meta["resources_dir"]
            + "/model/weights_v5/gex2adt/model_nn_gex2adt_v2_Nov16-16-02.pt"
        )
        y_pred_nn = pretrin_nn(
            par["input_test_mod1"], model_pth, MOD1_DIM, MOD2_DIM, FEAT_DIM, HIDDEN_DIM
        )
        ...
        model_pth = (
            meta["resources_dir"]
            + "/model/weights_v5/gex2adt/model_batchgan_gex2adt_v2_Nov16-15-47.pt"
        )
        ...
        model_pth = (
            meta["resources_dir"]
            + "/model/weights_v5/gex2adt/model_nn_gex2adt_v2_tfidfconcat_Nov17-13-24.pt"
        )
        mod1_idf = np.load(
        ...
        model_pth = (
            meta["resources_dir"]
            + "/model/weights_v5/gex2adt/model_nn_gex2adt_v2_tfidfconcat_Nov18-14-40.pt"
        )
        mod1_idf = np.load(
        ...
        model_pth = (
            meta["resources_dir"]
            + "/model/weights_v5/gex2adt/model_nn_gex2adt_v2_tfidfconcat_Nov18-14-53.pt"
        )
        mod1_idf = np.load(
            meta["resources_dir"] + "/model/idf_matrix/gex2adt/mod1_idf_v2.npy"
        )
    ...
    if LOAD_MODEL:
        ...
        model_pth = (
            meta["resources_dir"]
            + "/model/weights_v5/adt2gex/model_best_AtoB_cycle_adt2gex_v2_tfidfconcat_Nov17-21-42.pt"
        )
        mod1_idf = np.load(
        ...
        model_pth = (
            meta["resources_dir"]
            + "/model/weights_v5/adt2gex/model_best_AtoB_cycle_adt2gex_v2_Nov17-18-23.pt"
        )
        y_pred_nn = pretrin_nn(
            par["input_test_mod1"], model_pth, MOD1_DIM, MOD2_DIM, FEAT_DIM, HIDDEN_DIM
        )
    ...
    if LOAD_MODEL:
        ...
        model_pth = (
            meta["resources_dir"]
            + "/model/weights_v5/atac2gex/model_AtoB_cycle_atac2gex_v2_ga_Nov19-00-04.pt"
        )
        ...
        model_pth = (
            meta["resources_dir"]
            + "/model/weights_v5/atac2gex/model_AtoB_cycle_atac2gex_v2_ga_Nov19-10-45.pt"
        )
        ...
        model_pth = (
            meta["resources_dir"]
            + "/model/weights_v5/atac2gex/model_AtoB_cycle_atac2gex_v2_tfidf_Nov16-23-08.pt"
        )
        mod1_idf = np.load(
