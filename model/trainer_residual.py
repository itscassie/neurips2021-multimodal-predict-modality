...
class TrainProcess():
    def __init__(self, args):
        ...
        self.cmn_encoder = BN_common_encoder(args.mod1_dim, args.mod2_dim, args.emb_dim, args.hid_dim).cuda()
        self.resid_encoder = BN_resid_encoder(args.mod1_dim, args.mod2_dim, args.emb_dim, args.hid_dim).cuda()
