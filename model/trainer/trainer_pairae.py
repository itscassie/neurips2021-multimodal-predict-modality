""" pretrain common encoder and concat decoder """
import os
import logging
...
from modules.model_ae import CommonEncoder, ConcatEncoder


class TrainProcess:
    """ the training process for common encoder and concat decoder """
    ...
    def train_epoch(self, epoch):
        ...
        for batch_idx, (mod1_seq, mod2_seq) in enumerate(self.train_loader):
            ...
            mod1_recon, mod2_recon = self.decoder(
                mod1_common_emb, mod2_common_emb, zero_resid_emb, zero_resid_emb
            )
            ...
            common_emb_loss = self.args.cmn_loss_weight * self.mse_loss(
                mod1_common_emb, mod2_common_emb
            )
    ...
    def eval(self):
        ...
        for _, (mod1_seq, _) in enumerate(self.test_loader):
            ...
            _, mod2_rec = self.decoder(
                mod2_cm_emb, mod1_cm_emb, zero_resid_emb, zero_resid_emb
            )
