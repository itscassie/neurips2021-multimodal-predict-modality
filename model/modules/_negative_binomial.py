"""
This part of code contains simplified code from the python scvi package.
...
def log_mixture_nb(
    ...
    log_mixture_nb_out = logsumexp - softplus_pi

    return log_mixture_nb_out
