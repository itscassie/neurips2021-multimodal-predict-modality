...
par = {
    'input_train_mod1': mode['atac2gex'] + 'train_mod1.h5ad',
    'input_train_mod2': mode['atac2gex'] + 'train_mod2.h5ad',
    'input_test_mod1': mode['atac2gex'] + 'test_mod1.h5ad',
    # added for test, remove later
    # 'input_test_mod2': mode['atac2gex'] + 'test_mod2.h5ad',
...
if input_train_mod2.var['feature_types'][0] == 'ATAC':
    ...
    # ensemble
    y_pred = (np.array(y_pred_nn) + np.array(y_pred_nn2) + np.array(y_pred_concat)) / 3
