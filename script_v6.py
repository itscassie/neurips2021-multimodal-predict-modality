...
if input_train_mod2.var["feature_types"][0] == "ATAC":
    ...
    if LOAD_MODEL:
        ...
        model_pth = (
            meta["resources_dir"]
            + "/model/weights_v6/gex2adt/model_best_nn_gex2adt_v2_reg1_Nov18-21-24.pt"
        )
        ...
        model_pth = (
            meta["resources_dir"]
            + "/model/weights_v6/gex2adt/model_best_nn_gex2adt_v2_new_Nov20-09-35.pt"
        )
        ...
        model_pth = (
            meta["resources_dir"]
            + "/model/weights_v6/gex2adt/model_best_nn_gex2adt_v2_dropout0.3_Nov23-19-20.pt"
        )
        ...
        model_pth = (
            meta["resources_dir"]
            + "/model/weights_v6/gex2adt/model_best_batchgan_gex2adt_v2_dropout0.3_Nov24-22-36.pt"
        )
        ...
        model_pth = (
            meta["resources_dir"]
            + "/model/weights_v6/gex2adt/model_best_nn_gex2adt_v2_tfidfconcat_Nov18-14-53.pt"
        )
        mod1_idf = np.load(
        ...
        model_pth = (
            meta["resources_dir"]
            + "/model/weights_v6/gex2adt/model_best_nn_gex2adt_v2_tfidfconcat_new_Nov20-00-53.pt"
        )
        mod1_idf = np.load(
        ...
        model_pth = (
            meta["resources_dir"]
            + "/model/weights_v6/gex2adt/model_best_nn_gex2adt_v2_tfidfconcat_dropout0.3_Nov24-10-24.pt"
        )
        mod1_idf = np.load(
            meta["resources_dir"] + "/model/idf_matrix/gex2adt/mod1_idf_v2.npy"
        )
    ...
    if LOAD_MODEL:
        ...
        model_pth = (
            meta["resources_dir"]
            + "/model/weights_v6/adt2gex/model_best_AtoB_cycle_adt2gex_tfidfconcat_Nov03-14-47.pt"
        )
        mod1_idf = np.load(
        ...
        model_pth = (
            meta["resources_dir"]
            + "/model/weights_v6/adt2gex/model_best_AtoB_cycle_adt2gex_v2_dropout0.0_reg0_Nov22-18-51.pt"
        )
        y8b_pred_nn = pretrin_nn(
            par["input_test_mod1"], model_pth, MOD1_DIM, MOD2_DIM, FEAT_DIM, HIDDEN_DIM
        )
        ...
        model_pth = (
            meta["resources_dir"]
            + "/model/weights_v6/adt2gex/model_best_AtoB_cycle_adt2gex_v2_tfidfconcat_dropout0.0_reg0_Nov23-02-02.pt"
        )
        mod1_idf = np.load(
            meta["resources_dir"] + "/model/idf_matrix/adt2gex/mod1_idf_p2.npy"
        )
    ...
    if LOAD_MODEL:
        ...
        model_pth = (
            meta["resources_dir"]
            + "/model/weights_v6/atac2gex/model_best_AtoB_cycle_atac2gex_v2_Nov17-16-48.pt"
        )
        ...
        model_pth = (
            meta["resources_dir"]
            + "/model/weights_v6/atac2gex/model_best_AtoB_cycle_atac2gex_v2_ga_Nov19-10-45.pt"
        )
        ...
        model_pth = (
            meta["resources_dir"]
            + "/model/weights_v6/atac2gex/model_best_AtoB_cycle_atac2gex_v2_select2pct_tfidfconcatga_new_Nov22-11-45.pt"
        )
        ...
        # ensemble 3
        y_pred = (
            np.array(y4b_pred_ga) + np.array(y6b_pred_ga) + np.array(y12b_pred_tfidfga)
        ) / 3
