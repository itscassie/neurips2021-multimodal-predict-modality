...
if input_train_mod2.var["feature_types"][0] == "ATAC":
    ...
    if LOAD_MODEL:
        ...
        model_pth = (
            meta["resources_dir"]
            + "/../weights/model_best_nn_gex2adt_v2_Nov30-17-11.pt"
        )
        ...
        model_pth = (
            meta["resources_dir"]
            + "/../weights/model_best_nn_gex2adt_v2_Nov30-18-44.pt"
        )
        ...
        model_pth = (
            meta["resources_dir"]
            + "/../weights/model_best_nn_gex2adt_v2_dropout0.3_Nov30-20-18.pt"
        )
        ...
        model_pth = (
            meta["resources_dir"]
            + "/../weights/model_best_batchgan_gex2adt_v2_dropout0.3_Nov30-21-52.pt"
        )
        ...
        model_pth = (
            meta["resources_dir"]
            + "/../weights/model_best_nn_gex2adt_v2_tfidfconcat_Nov30-23-29.pt"
        )
        mod1_idf = np.load(
        ...
        model_pth = (
            meta["resources_dir"]
            + "/../weights/model_nn_gex2adt_v2_tfidfconcat_Dec01-04-22.pt"
        )
        mod1_idf = np.load(
        ...
        model_pth = (
            meta["resources_dir"]
            + "/../weights/model_best_nn_gex2adt_v2_tfidfconcat_dropout0.3_Dec01-08-37.pt"
        )
        mod1_idf = np.load(
            meta["resources_dir"] + "/model/idf_matrix/gex2adt/mod1_idf_v2.npy"
        )
    ...
    if LOAD_MODEL:
        ...
        model_pth = (
            meta["resources_dir"]
            + "/model/weights_v10/atac2gex/model_best_AtoB_cycle_atac2gex_v2_select2pct_tfidfconcatga_new_Nov22-11-45.pt"
        )
